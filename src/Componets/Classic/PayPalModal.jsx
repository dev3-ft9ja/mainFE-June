...
const content = {
  title: "PayPal",
  body: "Please make payment through the link below, upload receipt and send proof of payment to the specified email for confirmation. ",
};
...
const payPal = "http://PayPal.com/paypalme/ft9ja";
...
const PayPalModal = ({ open, handleClose, amount }) => {
